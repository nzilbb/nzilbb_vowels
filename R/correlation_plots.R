...
#' @param points add points to the plot on top of the violin (default: FALSE)
#' @return `ggplot` object.
#' @importFrom dplyr bind_rows filter mutate summarise
#' @importFrom ggplot2 ggplot aes labs geom_violin geom_jitter
#' @importFrom magrittr %>%
#' @importFrom glue glue
#' @examples
#'   # Test correlations (use at least n = 100)
...
plot_correlation_counts <- function(
    cor_test, alpha = 0.05, points = FALSE
) {
