#' Run permutation test on correlations in a dataset.
#'
#' Permute data a given number (n) of times, collecting pairwise correlations
#' and testing them for significance.
#'
...
#' @examples
#' \dontrun{correlation_test(pca_data, n = 100, cor.method = 'pearson')}
#' @export
...
# frame. Each pair only appears once.
...
#' Summary function for correlation test object. Set alpha to change significance
#'
